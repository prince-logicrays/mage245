<?php
namespace LR\ManageStudent\Model\Repository;

use LR\ManageStudent\Api\Data\ManageStudentInterface;
use LR\ManageStudent\Api\ManageStudentRepositoryInterface;
use Magento\Framework\Exception\AlreadyExistsException;
use Magento\Framework\Exception\CouldNotDeleteException;
use Magento\Framework\Exception\CouldNotSaveException;
use Magento\Framework\Exception\NoSuchEntityException;

use LR\ManageStudent\Model\ResourceModel\ManageStudent as ResourceModel;
...
use LR\ManageStudent\Api\Data\ManageStudentSearchResultsInterfaceFactory as SearchResultsFactory;
...
class ManageStudentRepository implements ManageStudentRepositoryInterface
{
     ...
     * @inheritDoc
     */
    public function save(\LR\ManageStudent\Api\Data\ManageStudentInterface $email)
    {
        try {
     ...
     * @inheritDoc
     */
    public function delete(\LR\ManageStudent\Api\Data\ManageStudentInterface $email)
    {
        if($email->getId()) {
            try {
