    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _EventListener: function () {
            ...
            $widget.element.on('click', '.' + options.optionClass, function () {
                document.querySelector('.reset-qty[name="resetqty"]').value = 1;
                document.querySelector('.entered-qty[name="qty"]').value = 1;
        ...
        _OnClick: function ($this, $widget) {
            ...
            $('.swatch-attribute').each(function () {
                var $element = $(this),
                    attrId = $element.attr('data-attribute-id'),
                    optionSelected = $element.attr('data-option-selected');
                if(typeof optionSelected == "undefined"){
                    ...
                    errorFlag = false;
                    // console.log(selectedSwatch[attrId])
                }
            });
            ...
            if(errorFlag == false){
                ...
                $.each(allTheProducts, function(index, value) {
                    if(isEquivalent(selectedSwatch, value)){
                        ...
                        var quantities = $widget.options.jsonConfig.quantities[index];
